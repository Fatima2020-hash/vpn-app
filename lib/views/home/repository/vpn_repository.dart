...
class VpnRepository {
  ...
  VpnRepository({this.onStatusChanged}) : _v2ray = FlutterV2ray(onStatusChanged: onStatusChanged ?? (_) {});
  ...
  Future<void> connect() async {
    ...
    await Future.microtask(() => _v2ray.startV2Ray(
      remark: "SOCKS5 VPN Ukraine",
      config: config,
      bypassSubnets: ['0.0.0.0/0'],
      proxyOnly: false,
    ));
